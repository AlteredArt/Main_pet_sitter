...
sitter1 = Sitter.create("Walk a Dog")
sitter2 = Sitter.create("Pet a Cat")
sitter3 = Sitter.create("Doggie Days")
sitter4 = Sitter.create("Feed a Cat")

appointment1 = Appointment.create(date: date, pet: "Waffles",sitter: "Walk the Dog")
pet1.appointments.create(date: date)